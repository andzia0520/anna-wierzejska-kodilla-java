...
public class CrudAppTestingApp {
    ...
    public static final String XPATH_TEXT_AREA = "//html/body/main/section/form/fieldset[2]/textarea";
    ...
    public static void main(String[] args) {
        ...
        driver.get("https://andzia0520.github.io/");

        WebElement searchField = driver.findElement(By.xpath(XPATH_INPUT));
        searchField.sendKeys("New robotic task");

        WebElement textareaField = driver.findElement(By.xpath(XPATH_TEXT_AREA));
